...
namespace ann_shop_server.Services
{
    public class CategoryPageService : Service<CategoryPageService>
    {
        ...
        /// <returns></returns>
        private List<CategoryProductModel> getProduct(string slug, string preOrder, int sort, ref PaginationMetadataModel pagination)
        {
            using (var con = new inventorymanagementEntities())
            {
                ...
                #region Lọc sản phẩm
                #region Lọc sản phâm theo preOrder
        ...
        /// <param name="pagination"></param>
        /// <returns></returns>
        public List<CategoryProductModel> getProductByCategory(string slug, int sort, ref PaginationMetadataModel pagination)
        {
            return this.getProduct(slug, String.Empty, sort, ref pagination);
        }
        ...
        /// <param name="pagination"></param>
        /// <returns></returns>
        public List<CategoryProductModel> getProductAll(int sort, ref PaginationMetadataModel pagination)
        {
            return this.getProduct(String.Empty, String.Empty, sort, ref pagination);
        }
        ...
        /// <param name="pagination"></param>
        /// <returns></returns>
        public List<CategoryProductModel> getProductOrderByCategory(string slug, string preOrder, int sort, ref PaginationMetadataModel pagination)
        {
            return this.getProduct(slug, preOrder, sort, ref pagination);
        }
        ...
        /// <param name="pagination"></param>
        /// <returns></returns>
        public List<CategoryProductModel> getProductOrderAll(string preOrder, int sort, ref PaginationMetadataModel pagination)
        {
            return this.getProduct(String.Empty, preOrder, sort, ref pagination);
        }
        #endregion
    }
}